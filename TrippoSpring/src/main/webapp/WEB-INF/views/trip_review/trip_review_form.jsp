	...
	<div class="wrapper">
		<div class="reviewTwoParts">
			<div class="reviewSidebar">
				<h1 class="reviewSidebarTitle">후기 작성하기</h1>
				<div>
				...
				<div id="insideReviewBoard">
					<div id="wwwh">
						...
						<form id="wwwh_form">
							...
							<div class="input-group-50-set">
								<div class="input-group-50">
									<span class="input-group-text">어디로</span> <input type="text"
										list="city" class="form-control" placeholder="여행지를 입력해주세요"
										name="wwhere">
									<datalist id="city">
										<option value="방콕, 태국">
								...
								<div class="input-group-50">
									<span class="input-group-text">비용</span> <input type="number"
										class="form-control" placeholder="총 여행 경비를 적어주세요"
										name="expence" style="text-align: right">
							...
							<div class="input-group-50-set">
							<div class="input-group-50">
								<span class="input-group-text">출발일</span> <input type="date"
									class="form-control" pattern="yyyy/MM/dd" name="wwhen1">
							</div>
							<div class="input-group-50">
								<span class="input-group-text">도착일</span> <input type="date"
									class="form-control" pattern="yyyy/MM/dd" name="wwhen2">
							</div>
							</div>
							<div class="input-group">
								...
								<span class="form-control">
									<div class="form-check">
										<input class="form-check-input" type="radio" name="wwith"
											id="1" value="부모님과"> <label class="form-check-label"
											for="1">부모님과</label>
									</div>
									<div class="form-check">
										<input class="form-check-input" type="radio" name="wwith"
											id="2" value="혼자여행"> <label class="form-check-label"
											for="2">혼자여행</label>
									</div>
									<div class="form-check">
										<input class="form-check-input" type="radio" name="wwith"
											id="3" value="친구와"> <label class="form-check-label"
											for="3">친구와</label>
									</div>
									<div class="form-check">
										<input class="form-check-input" type="radio" name="wwith"
											id="4" value="연인과"> <label class="form-check-label"
											for="4">연인과</label>
									</div>
									<div class="form-check">
										<input class="form-check-input" type="radio" name="wwith"
											id="5" value="아이와"> <label class="form-check-label"
											for="5">아이와</label>
									</div>
								</span>
							</div>
