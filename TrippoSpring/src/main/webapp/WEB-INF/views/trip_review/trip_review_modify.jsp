...
<link rel="stylesheet" type="text/css"
	href="css/trip_review/trip_review_modify.css">
<!-- ---------- -->
	...
	<div class="wrapper">
		<div class="reviewTwoParts">
			<div class="reviewSidebar">
				<h1 class="reviewSidebarTitle">후기 수정 하기</h1>
				<div>
						...
						<form name="wwwh_form" id="wwwh_form">
							...
							<div class="input-group">
								<span class="input-group-text">제목</span> <input type="text"
									class="form-control"
									value="<c:out value="${selectedReview.review_title }"/>"
									name="review_title">
							</div>
							<div class="input-group">
							...
							<div class="input-group-50">
								<span class="input-group-text">어디로</span> <input type="text"
									...
									value="<c:out value="${selectedReview.wwhere }"/>"
									autocomplete="on" name="wwhere">
								<datalist id="city">
									<option value="방콕, 태국">
							...
							<div class="input-group-50">
								<span class="input-group-text">비용</span> <input type="number"
									class="form-control"
									value="<c:out value="${selectedReview.expence }"/>"
							...
							<div class="input-group-50">
								<span class="input-group-text">출발일</span> <input type="date"
									...
									value="<c:out value="${selectedReview.wwhen1 }"/>"
									name="wwhen1">
							</div>
							<div class="input-group-50">
								<span class="input-group-text">도착일</span> <input type="date"
									class="form-control" pattern="yyyy/MM/dd"
									value="<c:out value="${selectedReview.wwhen2 }"/>"
									name="wwhen2">
							</div>
							</div>
							<div class="input-group">
								<span class="input-group-text">누구와</span> <span
									class="form-control">
							...
							<input id="contents" type="hidden" name="contents"
								value="<c:out value="${selectedReview.contents }"/>">
						</form>
					</div>
				</div>
			</div>
